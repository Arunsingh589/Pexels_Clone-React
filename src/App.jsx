...
const App = () => {
  ...
  const API_KEY = "YEtfUgePzYKls5wviLdejqhork3gQOY8E38kXUqyTBsW0pimlU3ribTX";


  useEffect(() => {
    const fetchImage = async () => {
      const res = await axios.get(`https://api.pexels.com/v1/search?query=${search}e&per_page=80`, {
        headers: {
